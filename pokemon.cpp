...
void pokemonData::ReadIcons(){
	string Location = "C:/Users/user/Desktop/C++實習專題/C++實習專題/termproj/assets/icons/color/";
	string Type = ".txt";
	string Num = "001";
	string Read;
...
{
	string Location = "C:/Users/user/Desktop/C++實習專題/C++實習專題/termproj/assets/type.csv";
	string Read;
	double read;
...
{
	string Location = "C:/Users/user/Desktop/C++實習專題/C++實習專題/termproj/assets/pokemons.csv";
